...
desc: '주식, 채권 등 여러 자산을 고려한 포트폴리오 생성 시뮬레이터. AI model을 활용해 과거 데이터 분석 및 미래 데이터 예측'
startMonth: '2022-04'
endMonth: '2022-08'
tags: 'React, Redux, styled-component, chart.js, Axios, google auth'
---

<div className="flex gap-4 justify-center">
<GitRepo url="https://github.com/d5br5/WEB_Robo_Advisor"/>
<ServiceLink url="https://www.naver.com"/>
</div>
