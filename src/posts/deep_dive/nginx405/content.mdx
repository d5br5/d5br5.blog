...
<Callout type='warn'>
  warn accent Critical content demanding immediate user attention due to potential risks. Critsssii
  content demanding immediate user attention due to potential risks. Critical content demanding
  immediate user attention due to potential risks.
</Callout>
...
<Callout type='danger'>
  danger destructive Critical content demanding immediate user attention due to potential risks.
</Callout>
