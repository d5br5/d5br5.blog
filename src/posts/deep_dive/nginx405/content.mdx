...
![image](/posts/deep_dive/nginx405/1.png)
_redirect된 페이지의 405 응답_
...
![image](/posts/deep_dive/nginx405/3.png)
_취소 redirect 페이지의 네트워크 요청 (405 응답)_
...
<Callout type='warn'>warn accent Critical content demanding immediate user attention due to potential risks. Critsssii content demanding immediate user attention due to potential risks. Critical content demanding immediate user attention due to potential risks.</Callout>

<Callout type='info'>info secondary Critical content demanding immediate user attention due to potential risks.</Callout>

<Callout type='danger'>danger destructive Critical content demanding immediate user attention due to potential risks.</Callout>
